...
#line 1 "parser.y" /* yacc.c:339  */
    ...
    #define add_tac($$, $1, $2, $3) {strcpy($$.type, $1.type);\
        ...
        vmcode.push_back("push " + string($1.lexeme));\
        vmcode.push_back("push " + string($3.lexeme));\
        vmcode.push_back(operator_map[string($2.lexeme)]);\
        vmcode.push_back("pop " + string($$.lexeme));}
    ...
    map<string, string> operator_map = {{"+", "add"}, {"-", "sub"}, {"==", "eq"}, {">", "gt"}, {"<", "lt"}, {"&", "and"}, {"|", "or"}, {"~", "not"}};
...
{
       0,   137,   137,   139,   140,   144,   143,   153,   152,   165,
     168,   173,   173,   181,   187,   192,   199,   200,   203,   204,
     205,   206,   207,   208,   209,   210,   216,   222,   223,   228,
     231,   237,   243,   250,   260,   266,   266,   275,   275,   283,
     293,   301,   304,   307,   314,   317,   320,   323,   326,   329,
     332,   335,   338,   341,   344,   347,   350,   353,   356,   359,
     362,   365,   368,   373,   378,   383,   388,   399,   411,   417,
     433,   439,   440,   441,   442,   445,   449,   453,   459,   467,
     476,   479,   492,   495,   476,   508,   513,   526,   529,   508,
     537,   540,   540,   541,   544,   549,   553,   544,   563,   567,
     570,   573,   570,   588,   589,   592,   599,   614,   592,   627,
     632,   650,   657,   627,   671,   671,   687,   695,   703,   706
};
#endif
...
#line 210 "parser.y" /* yacc.c:1646  */
    {
                        if(!loop_break.empty()){
                            ...
                            vmcode.push_back("goto #L" + to_string(loop_break.top()));
                        }
                    }
...
#line 216 "parser.y" /* yacc.c:1646  */
    {
                        if(!loop_continue.empty()){
                            ...
                            vmcode.push_back("goto #L" + to_string(loop_continue.top()));
                        }
                    }
...
#line 250 "parser.y" /* yacc.c:1646  */
    {
                        ...
                        vmcode.push_back("push " + string((yyvsp[-1].node).lexeme));
                        vmcode.push_back("pop " + string((yyvsp[-3].node).lexeme));
...
#line 293 "parser.y" /* yacc.c:1646  */
    {
                        ...
                        vmcode.push_back("push " + string((yyvsp[0].node).lexeme));
...
#line 417 "parser.y" /* yacc.c:1646  */
    {
                        ...
                        if(temp_map[string((yyvsp[0].node).lexeme)] == ""){
                            ...
                            // vmcode.push_back("push constant " + temp_map[string($1.lexeme)]);
                            // vmcode.push_back("pop " + string($$.lexeme));
                        }
                        vmcode.push_back("push constant " + string((yyvsp[0].node).lexeme));
                        vmcode.push_back("pop " + string((yyval.node).lexeme));
                    }
...
#line 459 "parser.y" /* yacc.c:1646  */
    {
                        ...
                        vmcode.push_back("push " + string((yyvsp[0].node).lexeme));
                        vmcode.push_back("pop " + string((yyvsp[-2].node).lexeme));
                    }
...
#line 479 "parser.y" /* yacc.c:1646  */
    { 
                        ...
                        vmcode.push_back("eq");
                        vmcode.push_back("if-goto #L" + to_string(label_counter+1));
...
#line 495 "parser.y" /* yacc.c:1646  */
    {  
                        ...
                        vmcode.push_back("goto " + string((yyvsp[-9].node).parentNext));
                        vmcode.push_back("\nlabel " + string((yyvsp[-6].node).else_body));
                    }
...
#line 502 "parser.y" /* yacc.c:1646  */
    {   
                        ...
                        vmcode.push_back("\nlabel " + string((yyvsp[-12].node).parentNext));
                    }
...
#line 599 "parser.y" /* yacc.c:1646  */
    {
                        ...
                        vmcode.push_back("push constant 0");
                        vmcode.push_back("eq");
                        vmcode.push_back("if-goto #L" + string((yyvsp[-1].node).else_body));
                        // vmcode.push_back("\nlabel " + string($4.if_body));
...
#line 617 "parser.y" /* yacc.c:1646  */
    {
                        ...
                        vmcode.push_back("goto " + string((yyvsp[-9].node).loop_body));
                        vmcode.push_back("\nlabel " + string((yyvsp[-6].node).else_body));
                        loop_continue.pop();
                        loop_break.pop();
                    }
...
#line 660 "parser.y" /* yacc.c:1646  */
    {
                        ...
                        vmcode.push_back("goto " + string((yyvsp[-9].node).loop_body));
                        vmcode.push_back("\nlabel " + string((yyvsp[-9].node).else_body));
