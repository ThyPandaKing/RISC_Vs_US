...
(
  ...
  reg [(Bits-1):0] memory[0:((1 << AddrBits) - 1)];
    initial begin
        $readmemb("/home/user/xilinx-projects/CPU/CPU.srcs/sim_1/new/ram_data.mem", memory);
  ...
  always @ (posedge C) begin
    if (str)
      memory[A] <= Din;
//      $writememb("/home/user/xilinx-projects/CPU/CPU.srcs/sim_1/new/ram_data.mem", memory);

    if(memory[A] == 32'b0 )    
      $writememb("/home/user/xilinx-projects/CPU/CPU.srcs/sim_1/new/memory_binary.mem", memory);
//      $writememb("/home/user/xilinx-projects/CPU/CPU.srcs/sim_1/new/memory_binary.mem", memory,1<<18, (1<<19)-1);
...
(
    ...
    initial begin
        $readmemb("/home/user/xilinx-projects/CPU/CPU.srcs/sim_1/new/reg_data.mem", memory);
    end
    ...
    always @ (posedge C) begin
        if (we)
            memory[Rw] <= Din;
//            $writememb("/home/user/xilinx-projects/CPU/CPU.srcs/sim_1/new/reg_data.mem", memory);
